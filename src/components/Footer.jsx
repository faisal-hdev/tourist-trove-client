...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-100 via-[#a7f3d0] to-gray-100">
      <div className="max-w-[1240px] mx-auto px-5 lg:px-0 py-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <Link
              to="/"
              className="text-xl md:text-3xl font-semibold cursor-pointer hover:text-emerald-500 text-black duration-200"
            >
              TouristTrove
            </Link>
            <p className="max-w-xs mt-5 text-sm md:text-[16px] text-gray-700">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas,
              accusantium.
            </p>
            <div className="flex mt-8 space-x-6 text-black cursor-pointer">
              <a
                className="hover:text-emerald-500 duration-200"
                rel="noreferrer"
              >
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <nav className="flex flex-col mt-5 space-y-5 text-sm md:text-[16px] text-gray-700">
        ...
        <p className="mt-8 text-xs text-gray-800">© 2024 TouristTrove-</p>
      </div>
    </footer>
  );
};
